...
public class MainActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Intent.ACTION_SEARCH.equals(i.getAction())){
            ...
            editor.putString("countrykey", Constants.countrykey);
            editor.putString("unitcode", Constants.unitcode);
            editor.putString("lang", Constants.lang);
            editor.apply();
        } else {
            city = prefs.getString("location",Constants.location);
        }
    ...
    public void getWeatherData(Boolean notification){
         ...
         */
        city = prefs.getString("location", Constants.location);
        CountryCode = prefs.getString("countrykey",  Constants.countrykey);
        unit = prefs.getString("unitcode",  Constants.unitcode);
        language = prefs.getString("lang",Constants.lang);

        /**
         * Start JSON data download
         */
        AsyncHttpClient client = new AsyncHttpClient();
        Log.e("AsyncHttpClient","AsyncHttpClient= "+"http://api.openweathermap.org/data/2.5/forecast/daily?q=" + city + "," + CountryCode + "&units=" + unit + "&lang=" + language + "&cnt=3&APPID=" + ApiKey);
    ...
    public void sendNotification(){
        if(prefs.getBoolean("notifications", true)){
            ...
            NotificationHelper.setTicker("Open Weather App");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_share){
            if (downloadSucessfull){
                String sharebody = "Open Weather App " + city + ", " + CountryCode + ": " + WeatherHelper.getDescription() + " bei " + String.format("%.1f", WeatherHelper.getTemperature_max()) + "°";
        ...
        if (drawerLayout.isDrawerOpen(GravityCompat.START)) {
            ...
            if(prefs.getBoolean("doubleback", true)){
                ...
                if(b == 2){
                    ...
                    Toast.makeText(MainActivity.this, getResources().getString(R.string.back), Toast.LENGTH_LONG).show();
                }
